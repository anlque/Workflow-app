...
5. Source Asset IDs must be unique. The set must agree exactly with normal and
   Bonus Environment references, including image for background and audio for audio.
